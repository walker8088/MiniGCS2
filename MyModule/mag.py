...
parser.add_option("--device1",
                  dest="device1",
                  default=None,
                  help="mavlink device1")
parser.add_option("--device2",
                  dest="device2",
                  default=None,
                  help="mavlink device2")
...
def set_attitude(rc3, rc4):
    ...
    mav2.mav.rc_channels_override_send(mav2.target_system,
                                       mav2.target_component, *values)
...
print(("Heartbeat from APM (system %u component %u)" %
      (mav1.target_system, mav1.target_system)))
print(("Heartbeat from APM (system %u component %u)" %
      (mav2.target_system, mav2.target_system)))
...
mav1.mav.set_mag_offsets_send(mav1.target_system, mav1.target_component, 0, 0,
                              0)
mav2.mav.set_mag_offsets_send(mav2.target_system, mav2.target_component, 0, 0,
                              0)
