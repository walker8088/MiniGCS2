...
# send the GET_DEVICE command and wait for an info parameter
    ...
    def identify(self, observer):
        ...
        if (self.bl_rev < uploader.BL_REV_MIN) or (self.bl_rev >
                                                   uploader.BL_REV_MAX):
            observer.info("Unsupported bootloader protocol %d" %
                          uploader.INFO_BL_REV)
...
def do_upload(frimware_file, port, observer):
    ...
    observer.info("Loaded firmware for %x,%x, waiting for the bootloader..." %
